 ...
 */
final class Version20230425053459 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE FavouriteProperty ADD CONSTRAINT FK_E098327F549213EC FOREIGN KEY (property_id) REFERENCES property (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE FavouriteProperty DROP FOREIGN KEY FK_E098327F549213EC');
        ...
        $this->addSql('DROP TABLE FavouriteProperty');
