 ...
 */
final class Version20230328115918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE property (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', owner_id VARCHAR(255) NOT NULL, property_area VARCHAR(255) NOT NULL, property_city VARCHAR(255) NOT NULL, property_country VARCHAR(255) NOT NULL, property_description VARCHAR(255) NOT NULL, property_image JSON DEFAULT NULL, property_price VARCHAR(255) NOT NULL, property_rooms VARCHAR(255) NOT NULL, property_state VARCHAR(255) NOT NULL, property_status VARCHAR(255) NOT NULL, property_title VARCHAR(255) NOT NULL, property_type VARCHAR(255) NOT NULL, short_description VARCHAR(255) NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_created_at DATETIME NOT NULL, is_updated_at DATETIME DEFAULT NULL, is_deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
