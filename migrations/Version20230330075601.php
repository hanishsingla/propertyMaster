 ...
 */
final class Version20230330075601 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE agent (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', owner_id VARCHAR(255) NOT NULL, agent_number VARCHAR(255) DEFAULT NULL, agent_name VARCHAR(255) NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_created_at DATETIME NOT NULL, is_updated_at DATETIME DEFAULT NULL, is_deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE property (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', owner_id VARCHAR(255) NOT NULL, property_is_garage TINYINT(1) DEFAULT 0 NOT NULL, property_area VARCHAR(255) NOT NULL, property_category VARCHAR(255) NOT NULL, property_city VARCHAR(255) NOT NULL, property_country VARCHAR(255) NOT NULL, property_description VARCHAR(255) NOT NULL, property_garage VARCHAR(255) DEFAULT NULL, property_image JSON DEFAULT NULL, property_price VARCHAR(255) NOT NULL, property_rooms VARCHAR(255) NOT NULL, property_state VARCHAR(255) NOT NULL, property_title VARCHAR(255) NOT NULL, property_type VARCHAR(255) NOT NULL, room_bed VARCHAR(255) NOT NULL, short_description VARCHAR(255) NOT NULL, square_type VARCHAR(255) NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_created_at DATETIME NOT NULL, is_updated_at DATETIME DEFAULT NULL, is_deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE security_user (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', user_information_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', owner_id VARCHAR(255) NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified TINYINT(1) NOT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_created_at DATETIME NOT NULL, is_updated_at DATETIME DEFAULT NULL, is_deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_52825A88E7927C74 (email), UNIQUE INDEX UNIQ_52825A884575EE58 (user_information_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE security_user_information (id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', owner_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, gender VARCHAR(255) NOT NULL, image VARCHAR(255) DEFAULT NULL, is_deleted TINYINT(1) DEFAULT 0 NOT NULL, is_created_at DATETIME NOT NULL, is_updated_at DATETIME DEFAULT NULL, is_deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE security_user ADD CONSTRAINT FK_52825A884575EE58 FOREIGN KEY (user_information_id) REFERENCES security_user_information (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE security_user DROP FOREIGN KEY FK_52825A884575EE58');
        ...
        $this->addSql('DROP TABLE security_user_information');
